...
public class UcAiBotController extends BaseCurdController<AiBotService, AiBot> {
    ...
    public UcAiBotController(AiBotService service, AiLlmService aiLlmService, AiBotWorkflowService aiBotWorkflowService,
